  ...
  return (
    <main className="font-inter text-white bg-dark-bg pt-32 md:pt-36 scroll-smooth">
      <section className="container mx-auto px-4 md:px-20 mb-10 md:mb-14" data-aos="fade-up">
        <p className="text-primary-accent uppercase tracking-[0.2em] text-sm mb-3">About</p>
        ...
        <p className="text-lg text-boulder max-w-3xl">
          Learn more about who we are, the values that drive us, and how we support businesses with
          trusted accounting expertise across every stage of growth.
        </p>
      </section>
